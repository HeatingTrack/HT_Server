...
public interface BoardRepository extends JpaRepository<Board, String> {
    ...
    @Query("select new schoolproject.capstone.dto.response.BoardDetailResponseDto(b.id, b.title, b.content, b.createdAt, u.name, u.id, b.type) from Board b join b.user u where b.num = :num")
